...
int main(int argc, char **argv)
{
    ...
    // 距離計算
    distance_angle_list[0][0]  = sqrt(pow(lidar_posit1on + TYPE1_X, 2) + pow(TYPE1_Y, 2)) - TYPE12_r;
    distance_angle_list[0][4]  = TYPE1_X - TYPE12_r;
    distance_angle_list[0][10] = distance_angle_list[0][0];
    distance_angle_list[0][2]  = sqrt(pow(lidar_posit1on + TYPE2_X, 2) + pow(TYPE2_Y, 2)) - TYPE12_r;
    distance_angle_list[0][8]  = distance_angle_list[0][2];
    distance_angle_list[0][5]  = TYPE1_X - TYPE12_r;
    distance_angle_list[0][3]  = sqrt(pow(lidar_posit1on + BACK_TYPE2_X, 2) + pow(BACK_TYPE2_Y, 2)) - TYPE12_r;
    distance_angle_list[0][7]  = distance_angle_list[0][3];
    distance_angle_list[0][1]  = sqrt(pow(lidar_posit1on + BACK_TYPE1_X, 2) + pow(BACK_TYPE1_Y, 2)) - TYPE12_r;
    distance_angle_list[0][6]  = TYPE1_X - TYPE12_r;
    distance_angle_list[0][9]  = distance_angle_list[0][1];
    // 角度計算
